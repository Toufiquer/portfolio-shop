...
const MutationContainer1 = ({ data, onSubmit }: ContainerFormProps) => {
            ...
            {sortedTemplates.map((item) => {
              ...
              return (
                <div
                  ...
                  className={`group relative overflow-hidden rounded-xl border bg-stone-50 backdrop-blur-md transition-all duration-200 ${
                ...
                >
                  ...
                  {isCompact ? (
                    ...
                    <div className="flex flex-col gap-1.5 p-3">
                      <h4 className="line-clamp-2 text-sm font-semibold leading-snug text-stone-800">
                        {item.title || "Untitled Product"}
                      </h4>
                      ...
                      <button
                        type="button"
                        onClick={() => removeTemplate(item.id)}
                        className="mt-2 inline-flex w-full items-center justify-center gap-1.5 rounded-lg border border-red-300/20 bg-red-500/10 px-3 py-2 text-xs font-bold text-red-200 transition-colors hover:bg-red-500/20 hover:text-stone-800"
                        aria-label={`Remove ${item.title}`}
                      >
                        <Trash2 size={13} /> Remove
                      </button>
