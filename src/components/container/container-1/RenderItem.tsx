...
const RenderItem = ({ item, settings }: RenderItemProps) => {
  ...
  return (
    <div className="group relative flex flex-col overflow-hidden rounded-sm border border-[#eadfca] bg-white transition duration-700 hover:border-amber-300">
      {/* Shimmer accent line */}
      ...
      <div className="flex flex-1 flex-col p-2.5">
        <h3 className="line-clamp-2 text-xs font-medium text-gray-700 transition-colors duration-200 group-hover:text-blue-700 md:text-sm">
          {item.title}
        </h3>
