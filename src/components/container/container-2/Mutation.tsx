...
const normalizeSettings = (data?: IContainerData): IContainerData => ({
  ...
  templates: (data?.templates?.length ? data.templates : defaultDataContainer2.templates).map((template) => ({
    ...template,
        ...
        <div className="mt-5 rounded-sm border border-[#eadfca] bg-[#fffaf0] p-4 sm:p-5">
          <div className="mb-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h4 className="text-xs font-bold uppercase tracking-wider text-stone-700">Section Navigation & Carousel</h4>
            </div>
            ...
            <div className="relative flex items-center justify-between gap-4 border-b border-[#eadfca] bg-[#fffaf0] p-4 sm:p-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-stone-500">
                    Select products from your catalogue to include in this carousel.
                  </p>
                </div>
              </div>
              <button
